...
void Send_CMD(unsigned char HCMD, unsigned char LCMD)
{
...
void Send_CMD_DAT(unsigned char HCMD, unsigned char LCMD, char *dat, unsigned int dat_len)
{
    unsigned char cnt = 0;
    unsigned int ncrc = 0;
...
int main()
{
    ...
    strtmp[1]=0x30;
    strtmp[2]=0x15;
    Send_CMD_DAT(0x01,0x14,strtmp,3);
    strtmp[0]=0x15;
    strtmp[1]=0x30;
    Send_CMD_DAT(0x01,0x16,strtmp,2);
    strtmp[0]=0x15;
    strtmp[1]=0x30;
    Send_CMD_DAT(0x01,0x17,strtmp,2);
    return 0;
}
